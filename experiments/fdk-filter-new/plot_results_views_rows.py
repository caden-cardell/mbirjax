...
channels, time, gb = zip(*paired)

fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))

ax1.plot(channels, time, marker='o', markersize=3)
ax1.set_xlabel('Number of Channels')
ax1.set_ylabel('Time (seconds)')
ax1.set_title('Time vs Channels (views=512, rows=512)')
ax1.grid(True, alpha=0.3)

ax2.plot(channels, gb, marker='o', markersize=3, color='orange')
...
print(f"Saved to logs/fdk_filter_views512_rows512.png ({len(channels)} data points)")
